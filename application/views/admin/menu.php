                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo base_url();?>etc/dist/img/user3-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo base_url();?>etc/dist/img/user4-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                            Developers
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Log</a></li>
                <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Popular Site</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
